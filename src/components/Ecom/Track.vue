<template>
  <v-container>
    <p class="display-3 font-weight-light	text-center pa-4">Track Order</p>
      ...
      <div class="col-md-12">
        <div class="well">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control" id="inputOrderTrackingID" value=""
                  placeholder="# put your order id here" v-model="enterID">
              </div>
            </div>
            <div class="form-group">
              <div class="col-sm-offset-2 col-sm-10">
                <button type="button" id="shopGetOrderStatusID" class="btn btn-success"
                  @click="tracking(this.enterID)">Get status</button>
              </div>
            </div>
          </div>
          ...
          <ul class="list-group">
            ...
            <li class="list-group-item">
              <span class="prefix">Expected Delivery:</span>
              <span class="label label-success">12.15.2013</span>
            </li>
            <li class="list-group-item">
              <span class="prefix">Shipped with:</span>
              <span class="label label-success">TCS Courier</span>
            </li>
            <li class="list-group-item">
              <span class="prefix">Status:</span>
              <span class="label label-success">{{ viewOrder.stauts }}</span>
            </li>
          </ul>
